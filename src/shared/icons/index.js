...
import LungFailureIconA from "./lung_failure";
import KidneyFailureIconA from "./kidney_failure";
// import LiverFailureIconA from "./liver_failure";
import LiverFailureIconB from "./liver_failure2";
...
export const BrainFailureIcon = BrainFailureIconA;
export const LungFailureIcon = LungFailureIconA;
export const KidneyFailureIcon = KidneyFailureIconA;
